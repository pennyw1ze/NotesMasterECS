...
In the table~\ref{tab:zk_systems_trusted_setup}, we summarize the main zero-kwowledge proof systems that are used
...
parallel. This results are shown in order to justify the implementations choices
